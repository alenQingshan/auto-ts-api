...
import { CulturalProductSpecRead } from './CulturalProductSpecRead.model';
import { CulturalProductSkuRead } from './CulturalProductSkuRead.model';

export interface CulturalProductRead {
  /**
   * 商品名称（默认语言）
   */
  name: string | null;
   ...
   * 规格列表
   */
  specs?: CulturalProductSpecRead[] | null;
  /**
   * SKU列表
   */
  skus?: CulturalProductSkuRead[] | null;
}